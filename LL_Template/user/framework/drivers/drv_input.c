...
uint8_t  TIM5_CH1_CAPTURE_STA=0; //输入捕获的状态
uint32_t TIM5_CH1_CAPTURE_VAL=0;//输入捕获值(TIM2/TIM5是32位)
...
* 输    出         : 无
*******************************************************************************/
void TIM5_CH1_Input_Init(uint32_t arr,uint32_t psc)
{
...
/*
	...
	LED_Init();
	USART1_Init(115200);
	TIM5_CH1_Input_Init(0xffff,83);  //以1M频率计数
